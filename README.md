...
![proof of both servers running](images/proof-of-both-servers-running.png)

## Step two: create a bash script to automate the deployment of a LAMP stack.
#### Screenshots;
![testing script on master node](images/testing-script-on-masternode1.png)
![testing script on master node](images/testing-script-on-masternode2.png)

## Step three: Using Ansible playbook to execute the bash script on the Slave node.
#### Screenshots;
![proof of successful execution of ansible playbook and cronjob](images/proof-of-running-playbook-successfully-and-cronjob-execution.png)
